...
<Window
  ...
  <Window.Resources>
    ...
    <Style x:Key="DangerBtn" TargetType="Button">
      <Setter Property="Background" Value="#DC2626"/><Setter Property="Foreground" Value="White"/>
      <Setter Property="FontSize" Value="13"/><Setter Property="FontWeight" Value="SemiBold"/>
      <Setter Property="Padding" Value="22,10"/><Setter Property="BorderThickness" Value="0"/>
      <Setter Property="Cursor" Value="Hand"/>
      <Setter Property="Template">
        <Setter.Value>
          <ControlTemplate TargetType="Button">
            ...
            <ControlTemplate.Triggers>
              ...
              <Trigger Property="IsPressed"   Value="True"><Setter TargetName="bd" Property="Background" Value="#B91C1C"/></Trigger>
              <Trigger Property="IsEnabled"   Value="False">
                <Setter TargetName="bd" Property="Background" Value="#1A1A24"/><Setter Property="Foreground" Value="#374151"/>
              </Trigger>
            </ControlTemplate.Triggers>
      ...
      <Grid>
        ...
        <Border Grid.Row="2" Background="#0D0D15" CornerRadius="0,0,12,12" BorderBrush="#1E1E2E" BorderThickness="0,1,0,0">
          <Grid Margin="16,0">
            ...
            <StackPanel Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Center">
              <TextBlock Text="Device Cleanup v1.0  " Foreground="#252530" FontSize="11" VerticalAlignment="Center"/>
              <TextBlock Text="Admin"                 Foreground="#1D4ED8" FontSize="11" FontWeight="SemiBold" VerticalAlignment="Center"/>
            </StackPanel>
          </Grid>
        </Border>
...
function Show-ConfirmDialog {
    ...
    $dx += '<Button x:Name="BtnYes" Content="Remove" Width="88" Height="34" FontSize="12" FontWeight="SemiBold" Foreground="White"   Background="#DC2626" BorderThickness="0" Cursor="Hand">'                                      + $tYes + '</Button>'
